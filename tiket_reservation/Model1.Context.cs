...
namespace tiket_reservation
{
    ...
    public partial class tiket_reservation_54418853Entities : DbContext
    {
        public tiket_reservation_54418853Entities()
            : base("name=tiket_reservation_54418853Entities")
        {
        }
